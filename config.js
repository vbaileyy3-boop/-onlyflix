/* ============================================================
   config.js — TMDB config + STREAM SOURCE RESOLVER LAYER (FIXED)
   ============================================================ */
const TMDB = {
...
const SOURCE_REGISTRY = {
  ...
  // Format: "movie:TMDBID" or "tv:TMDBID" or "tv:TMDBID:S1E1"
};
...
const EMBED_SERVERS = [
  ...
  // FIX: 2Embed TV URL was missing the `?` before query params, producing a malformed URL
  // like /embedtv/123&s=1&e=1 instead of /embedtv/123?s=1&e=1.

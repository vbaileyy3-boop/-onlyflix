/* ============================================================
   api.js — TMDB live data client (FIXED v3)
   ============================================================
   Changes vs v2:
   - NEW: api.recommendations(type, tmdbId) for the detail modal's
     "More Like This" row. Non-throwing: returns [] on failure so the
     detail view never breaks if recommendations are unavailable.
   ============================================================ */
const GENRE_MAP = {};
let ALL_GENRES = [];
...
const api = {
  ...
  // NEW: recommendations for the detail modal "More Like This" row.
  // Non-throwing: returns [] on failure so the detail view never breaks.

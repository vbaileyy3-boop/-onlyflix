...
// Core fetch with retry - solid, keeping it
...
// Normalize - cleaner type detection
function norm(x) {
...
// Generic endpoint wrapper - kills all the boilerplate
...
// Build all endpoints from config
const endpoints = {
...
// Search - special case for query param
api.search = (q, p = 1) => endpoint("/search/multi")({ query: q, page: p });

// Discover - type-specific params
...
// Genre row - slice in the transform
